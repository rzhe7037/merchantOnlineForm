...
<?php include_once('./models/verify_application.php') ?>
...
<div class="container">
    <h5 class="my-3 font-weight-bold">Create new shop</h5>
    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="input-group mb-1">
                    ...
                    <input type="text" class="form-control " name="trading_name" value=<?php echo isset($_POST['trading_name'])?$_POST['trading_name']:""?>>
                </div>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="input-group mb-1">
                    ...
                    <input type="text" class="form-control " name="company_name" value=<?php echo isset($_POST['company_name'])?$_POST['company_name']:""?>>
                </div>
            </div>
        </div>
                ...
                <div class="input-group mb-1">
                    <div id="locationField">
                        <input id="autocomplete" name="address" placeholder="Enter your address" onfocus="geolocate()"
                            type="text" autocomplete="off" class="form-control" value='<?php echo isset($_POST['address'])?$_POST['address']:""?>'>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="input-group mb-1"id="street_name">
                    ...
                    <input type="text" class="form-control" name="address_street_number" id="street_number" value=<?php echo isset($_POST['address_street_number'])?$_POST['address_street_number']:""?>>
                    <input type="text" class="form-control" name="address_route" id="route" value=<?php echo isset($_POST['address_route'])?$_POST['address_route']:""?>>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="input-group mb-1">
                    ...
                    <input id="locality" type="text" class="form-control field" name="address_suburb" value=<?php echo isset($_POST['address_suburb'])?$_POST['address_suburb']:""?>>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-6 pr-0">
                <div class="input-group mb-1">
                    ...
                    <input id="administrative_area_level_1" type="text" class="form-control field" name="address_state" value=<?php echo isset($_POST['address_state'])?$_POST['address_state']:""?>>
                </div>
            </div>
            <div class="col-6 pl-0">
                <div class="input-group mb-1">
                    ...
                    <input type="number" id="postal_code" class="form-control field" name="address_postcode" value=<?php echo isset($_POST['address_postcode'])?$_POST['address_postcode']:""?>>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="input-group mb-1">
                    ...
                    <input type="text" class="form-control" name="owner_name" value=<?php echo isset($_POST['owner_name'])?$_POST['owner_name']:""?>>
                </div>
            </div>
            <div class="col-md-6">
                <div class="input-group mb-1">
                    ...
                    <input type="checkbox" id="managedBy" name="managed_by" onclick="toggleManagerInput()" <?php if(isset($_POST['managed_by'])) echo "checked"?>>
                </div>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="input-group mb-1">
                    ...
                    <input type="tel" class="form-control" name="owner_mobile" placeholder="04xx xxx xxx " value=<?php echo isset($_POST['owner_mobile'])?$_POST['owner_mobile']:""?>>
                </div>
            </div>
            <div class="col-md-6">
                <div class="input-group mb-1">
                    ...
                    <input type="tel" class="form-control" name="shop_number" placeholder="04xx xxx xxx " value=<?php echo isset($_POST['shop_number'])?$_POST['shop_number']:""?>>
                </div>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row" id="manager_bar">
            <div class="col-md-6">
                <div class="input-group mb-1">
                    ...
                    <input type="text" class="form-control" name="manager_name" value=<?php echo isset($_POST['manager_name'])?$_POST['manager_name']:""?>>
                </div>
            </div>
            <div class="col-md-6">
                <div class="input-group mb-1">
                    ...
                    <input type="tel" class="form-control" name="manager_phone" placeholder="04xx xxx xxx" value=<?php echo isset($_POST['manager_phone'])?$_POST['manager_phone']:""?> >
                </div>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="input-group mb-1"  id="pos_bar">
                    <div class="form-check form-check-inline my-1">
                        <input class="form-check-input" type="radio" name="pos_type" value="known" onclick="togglePosTextBox()">
        ...
        <div class="form-group">
            ...
            <textarea class="form-control" name="comment"><?php echo isset($_POST['comment'])?$_POST['comment']:""?></textarea>
        </div>
